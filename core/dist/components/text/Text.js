...
function Text(_a) {
    ...
    var childrenElement = typeof children === 'string'
        ...
        : children;
    return (_jsx(TextContext.Provider, __assign({ value: true }, { children: _jsx("span", __assign({ ref: textElementRef }, { autoFocus: autoFocus }, { "data-test-id": testId, className: textClassName }, props, { children: childrenElement })) })));
}
export default Text;
