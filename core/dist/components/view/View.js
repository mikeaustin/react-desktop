...
var View = function (_a, ref) {
    var _b = _a.as, Component = _b === void 0 ? 'div' : _b, flex = _a.flex, horizontal = _a.horizontal, align = _a.align, fillColor = _a.fillColor, padding = _a.padding, border = _a.border, borderColor = _a.borderColor, disabled = _a.disabled, viewBox = _a.viewBox, hoverable = _a.hoverable, hovered = _a.hovered, className = _a.className, testId = _a.testId, children = _a.children, props = __rest(_a, ["as", "flex", "horizontal", "align", "fillColor", "padding", "border", "borderColor", "disabled", "viewBox", "hoverable", "hovered", "className", "testId", "children"]);
    ...
    return (_jsx(ViewContext.Provider, __assign({ value: { isHorizontal: horizontal !== null && horizontal !== void 0 ? horizontal : false } }, { children: _jsx(Component, __assign({ ref: ref, disabled: disabled, viewBox: viewBox, className: viewClassName, "data-test-id": testId, onDragOver: handleDragOver, onDragEnter: handleDragOver }, props, { children: children })) })));
};
